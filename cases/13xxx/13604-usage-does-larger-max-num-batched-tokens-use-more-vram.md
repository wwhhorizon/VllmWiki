# vllm-project/vllm#13604: [Usage]: Does larger max_num_batched_tokens use more VRAM?

| 字段 | 值 |
| --- | --- |
| Issue | [#13604](https://github.com/vllm-project/vllm/issues/13604) |
| 状态 | closed |
| 标签 | usage |
...
> [Usage]: Does larger max_num_batched_tokens use more VRAM?
