# vllm-project/vllm#20100: not run

| 字段 | 值 |
| --- | --- |
| Issue | [#20100](https://github.com/vllm-project/vllm/issues/20100) |
| 状态 | closed |
| 标签 | bug |
...
### Your current environment error ### 🐛 Describe the bug [x.txt](https://github.com/user-attachments/files/20912811/x.txt) ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and asked the chatbot living at the bottom right corner of the [documentation page](https://docs.vllm.ai/en/latest/), which can answer lots of frequently asked questions.
