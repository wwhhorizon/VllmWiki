# vllm-project/vllm#31124: [Bug]: vllm.entrypoints.openai.api_server started but can't be accessed in wsl

| 字段 | 值 |
| --- | --- |
| Issue | [#31124](https://github.com/vllm-project/vllm/issues/31124) |
| 状态 | open |
| 标签 | bug |
...
> [Bug]: vllm.entrypoints.openai.api_server started but can't be accessed in wsl

### Issue 正文摘录

### Your current environment ### 🐛 Describe the bug quite similar issue as https://github.com/vllm-project/vllm/issues/10116 but i didn't find solution there. I started the server with vllm serve command and the log shows the server is successfully started, but i can't connect to the server using curl or nc. I tried lsof and the output show the port is listen. I also tried starting other http services in wsl and it can be accesed, so i think it's a bug rather something about my network setup. can someone help me with this? ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and asked the chatbot living at the bottom right corner of the [documentation page](https://docs.vllm.ai/en/latest/), which can answer lots of frequently asked questions.
