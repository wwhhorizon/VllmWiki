# vllm-project/vllm#3584: [Bug]: 使用ReAct时 ActionInput 多了 ‘Observ’字符导致tool调用出错

| 字段 | 值 |
| --- | --- |
| Issue | [#3584](https://github.com/vllm-project/vllm/issues/3584) |
| 状态 | closed |
| 标签 | bug |
...
- [硬件架构 Guard](../patterns/hardware_arch_guard.md) - 分数 7: onment information... PyTorch version: 2.1.2+cu121 Is debug build: False CUDA used to build PyTorch: 12.1 ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.3 LTS (x86_64) GCC version: (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4....
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 5: l调用出错 bug ### Your current environment ```text Collecting environment information... PyTorch version: 2.1.2+cu121 Is debug build: False CUDA used to build PyTorch: 12.1 ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.3...
