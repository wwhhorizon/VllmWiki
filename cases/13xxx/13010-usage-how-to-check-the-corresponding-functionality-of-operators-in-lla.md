# vllm-project/vllm#13010: [Usage]: How to check the corresponding functionality of operators in Llama-2-7b-hf?

| 字段 | 值 |
| --- | --- |
| Issue | [#13010](https://github.com/vllm-project/vllm/issues/13010) |
| 状态 | closed |
| 标签 | usage;stale |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 5: [Usage]: How to check the corresponding functionality of operators in Llama-2-7b-hf? usage;stale ### Your current environment Collecting environment information... PyTorch version: 2.5.1+cu124 Is debug build: False CUDA...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 3: eck the corresponding functionality of operators in Llama-2-7b-hf? usage;stale ### Your current environment Collecting environment information... PyTorch version: 2.5.1+cu124 Is debug build: False CUDA used to build PyT...
- [验证与 Benchmark](../patterns/verification_benchmarking.md) - 分数 3: ## How would you like to use vllm My vllm version is 0.6.6. This is my test.py file, I have already set up the source environment. How can I debug to see which low-level operators are being used, or is there a profiler...
