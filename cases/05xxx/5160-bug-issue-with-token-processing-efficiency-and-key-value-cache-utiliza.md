# vllm-project/vllm#5160: [Bug]: Issue with Token Processing Efficiency and Key-Value Cache Utilization in AsyncLLMEngine

| 字段 | 值 |
| --- | --- |
| Issue | [#5160](https://github.com/vllm-project/vllm/issues/5160) |
| 状态 | closed |
| 标签 | bug |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 6: e output of `python collect_env.py` ``` ```cmd Collecting environment information... PyTorch version: 2.3.0+cu121 Is debug build: False CUDA used to build PyTorch: 12.1 ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.4...
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 5: d_ppin arat npt lbrv svm_lock nrip_save tsc_scale vmcb_clean flushbyasid decodeassists pausefilter pfthreshold v_vmsave_vmload vgif v_spec_ctrl umip pku ospke vaes vpclmulqdq rdpid overflow_recov succor smca Virtualizat...
