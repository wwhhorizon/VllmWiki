# vllm-project/vllm#3696: [Bug]: VLLM OOMing unpredictably on prediction

| 字段 | 值 |
| --- | --- |
| Issue | [#3696](https://github.com/vllm-project/vllm/issues/3696) |
| 状态 | closed |
| 标签 | bug;stale |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 4: diction bug;stale ### Your current environment Collecting environment information... PyTorch version: N/A Is debug build: N/A CUDA used to build PyTorch: N/A ROCM used to build PyTorch: N/A OS: Ubuntu 20.04.6 LTS (x86_6...
- [Backend 路由与 Fallback](../patterns/backend_routing_fallback.md) - 分数 2: tion _can_ happen? e.g. if you set `gpu_memory_utilization` to 50% like[ Triton does ](https://github.com/triton-inference-server/vllm_backend/blob/c1c88fa7dfbebcd3198ada913e127304d5ff0b46/samples/model_repository/vllm_...
