# vllm-project/vllm#43221: [Bug]: Streaming reasoning tokens truncated when `</think>` and `<tool_call>` appear in the same delta

| 字段 | 值 |
| --- | --- |
| Issue | [#43221](https://github.com/vllm-project/vllm/issues/43221) |
| 状态 | closed |
| 标签 | bug |
