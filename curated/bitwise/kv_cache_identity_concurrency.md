...
- [#44250](https://github.com/vllm-project/vllm/issues/44250) 与 [#42125](https://github.com/vllm-project/vllm/issues/42125) 都还是强 defer：已有强复现，但没有上游 patch/test 前，不能把 external KV version-aware key 或 runtime adapter invalidation 写成已落地 fix。
