# vllm-project/vllm#12881: [Usage]: max_num_seqs的含义

| 字段 | 值 |
| --- | --- |
| Issue | [#12881](https://github.com/vllm-project/vllm/issues/12881) |
| 状态 | closed |
| 标签 | usage |
