# vllm-project/vllm#21369: [Usage]: cannot import name 'VoxtralForConditionalGeneration' from 'transformers'

| 字段 | 值 |
| --- | --- |
| Issue | [#21369](https://github.com/vllm-project/vllm/issues/21369) |
| 状态 | closed |
| 标签 | usage |
...
- [构建、依赖与打包](../patterns/build_dependency_packaging.md) - 分数 3: [Usage]: cannot import name 'VoxtralForConditionalGeneration' from 'transformers' usage ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run inf...
