# vllm-project/vllm#3586: [Usage]: How to call the paged_attention_v2 on my own q and kv caches?

| 字段 | 值 |
| --- | --- |
| Issue | [#3586](https://github.com/vllm-project/vllm/issues/3586) |
| 状态 | closed |
| 标签 | usage |
...
> [Usage]: How to call the paged_attention_v2 on my own q and kv caches?
...
- [构建、依赖与打包](../patterns/build_dependency_packaging.md) - 分数 7: my own q and kv caches? usage ### Your current environment ``` PyTorch version: 2.1.2+cu121 Is debug build: False CUDA used to build PyTorch: 12.1 ROCM used to build PyTorch: N/A OS: Red Hat Enterprise Linux 8.9 (Ootpa)...
...
- [Dtype、量化与 Scale 路径](../patterns/dtype_quantization_path.md) - 分数 4: l clzero irperf xsaveerptr wbnoinvd arat npt lbrv svm_lock nrip_save tsc_scale vmcb_clean flushbyasid decodeassists pausefilter pfthreshold avic v_vmsave_vmload vgif v_spec_ctrl umip rdpid overflow_recov succor smca sme...
