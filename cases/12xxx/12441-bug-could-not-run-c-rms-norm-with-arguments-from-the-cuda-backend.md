# vllm-project/vllm#12441: [Bug]: Could not run '_C::rms_norm' with arguments from the 'CUDA' backend.

| 字段 | 值 |
| --- | --- |
| Issue | [#12441](https://github.com/vllm-project/vllm/issues/12441) |
| 状态 | closed |
| 标签 | bug |
...
- [硬件架构 Guard](../patterns/hardware_arch_guard.md) - 分数 5: [Bug]: Could not run '_C::rms_norm' with arguments from the 'CUDA' backend. bug ### Your current environment env ``` Collecting environment information... PyTorch version: 2.5.1+cu124 Is debug build: False CUDA used to...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 5: kend. bug ### Your current environment env ``` Collecting environment information... PyTorch version: 2.5.1+cu124 Is debug build: False CUDA used to build PyTorch: 12.4 ROCM used to build PyTorch: N/A OS: CentOS Linux 7...
- [Backend 路由与 Fallback](../patterns/backend_routing_fallback.md) - 分数 4: [Bug]: Could not run '_C::rms_norm' with arguments from the 'CUDA' backend. bug ### Your current environment env ``` Collecting environment information... PyTorch version: 2.5.1+cu124 Is debug build: False CUDA used to...
