# vllm-project/vllm#9733: [Usage]: It seems succeed to deploy llm. but I get errors when "curl http://127.0.0.1:8011/v1/models"

| 字段 | 值 |
| --- | --- |
| Issue | [#9733](https://github.com/vllm-project/vllm/issues/9733) |
| 状态 | closed |
| 标签 | usage |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 1: ceed to deploy llm. but I get errors when "curl http://127.0.0.1:8011/v1/models" usage ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run infe...
