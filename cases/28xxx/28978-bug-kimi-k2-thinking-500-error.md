# vllm-project/vllm#28978: [Bug]: kimi-k2-thinking 500 error

| 字段 | 值 |
| --- | --- |
| Issue | [#28978](https://github.com/vllm-project/vllm/issues/28978) |
| 状态 | closed |
| 标签 | bug |
...
> [Bug]: kimi-k2-thinking 500 error
...
- [构建、依赖与打包](../patterns/build_dependency_packaging.md) - 分数 1: [Bug]: kimi-k2-thinking 500 error bug ### Your current environment vllm docker nightly vllm=0.11.1rc7.dev109+gca00b1bfc.cu129 ### 🐛 Describe the bug When I deployed k2-thinking on multiple machines using vllm and ray, t...
