# vllm-project/vllm#5076: [Bug]: The inference speed of vllm running command-r-plus-gptq is very slow

| 字段 | 值 |
| --- | --- |
| Issue | [#5076](https://github.com/vllm-project/vllm/issues/5076) |
| 状态 | closed |
| 标签 | bug |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 5: slow bug ### Your current environment ```text Collecting environment information... PyTorch version: 2.3.0+cu121 Is debug build: False CUDA used to build PyTorch: 12.1 ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.4...
...
- [Backend 路由与 Fallback](../patterns/backend_routing_fallback.md) - 分数 1: -nccl-cu12==2.20.5 [pip3] torch==2.3.0 [pip3] torchvision==0.18.0 [pip3] triton==2.3.0 [pip3] vllm_nccl_cu12==2.18.1.0.4.0 [conda] numpy 1.26.4 pypi_0 pypi [conda] nvidia-nccl-cu12 2.20.5 pypi_0 pypi [conda] torch
