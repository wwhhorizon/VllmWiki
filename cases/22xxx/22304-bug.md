# vllm-project/vllm#22304: [Bug]:

| 字段 | 值 |
| --- | --- |
| Issue | [#22304](https://github.com/vllm-project/vllm/issues/22304) |
| 状态 | closed |
| 标签 | bug |
...
- [硬件架构 Guard](../patterns/hardware_arch_guard.md) - 分数 4: [Bug]: bug ### Your current environment vllm==0.9.2 export CUDA_VISIBLE_DEVICES=1,2 vllm serve /mnt/general/models/Qwen3-30B-A3B-Instruct-2507-FP8 \ --served-model-name Qwen3-30B-A3B-Instruct-2507-FP8 \ --tensor-paralle...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 4: vllm==0.9.2 export CUDA_VISIBLE_DEVICES=1,2 vllm serve /mnt/general/models/Qwen3-30B-A3B-Instruct-2507-FP8 \ --served-model-name Qwen3-30B-A3B-Instruct-2507-FP8 \ --tensor-parallel-size 2 \ --pipeline-parallel-size 1 \...
