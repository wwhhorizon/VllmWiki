# vllm-project/vllm#32445: [Bug]: GLMASR rope error

| 字段 | 值 |
| --- | --- |
| Issue | [#32445](https://github.com/vllm-project/vllm/issues/32445) |
| 状态 | closed |
| 标签 | bug |
...
> [Bug]: GLMASR rope error

### Issue 正文摘录

### Your current environment ### 🐛 Describe the bug the partial_rotary_factor is 0.5 ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and asked the chatbot living at the bottom right corner of the [documentation page](https://docs.vllm.ai/en/latest/), which can answer lots of frequently asked questions.
