# vllm-project/vllm#17941: [Usage]: Can't access vllm serve when load local model

| 字段 | 值 |
| --- | --- |
| Issue | [#17941](https://github.com/vllm-project/vllm/issues/17941) |
| 状态 | closed |
| 标签 | usage |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 6: [Usage]: Can't access vllm serve when load local model usage ### Your current environment ```text INFO 05-10 15:40:20 [__init__.py:239] Automatically detected platform cuda. Collecting environment information... /home/t...
- [硬件架构 Guard](../patterns/hardware_arch_guard.md) - 分数 5: xt INFO 05-10 15:40:20 [__init__.py:239] Automatically detected platform cuda. Collecting environment information... /home/tongzhao/fine_tunning/.venv/lib/python3.10/site-packages/_distutils_hack/__init__.py:30: UserWar...
