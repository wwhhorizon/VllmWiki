# vllm-project/vllm#38642: [Usage]: 模型返回值reasoning_content

| 字段 | 值 |
| --- | --- |
| Issue | [#38642](https://github.com/vllm-project/vllm/issues/38642) |
| 状态 | open |
| 标签 | usage |
...
> [Usage]: 模型返回值reasoning_content

### Issue 正文摘录

### Your current environment 模型返回值，这个字段不是reasoning_content吗？新版本修改成了reasoning ？有配置可以设置这个返回key吗？ ### How would you like to use vllm I want to run inference of a [specific model](put link here). I don't know how to integrate it with vllm. ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and asked the chatbot living at the bottom right corner of the [documentation page](https://docs.vllm.ai/en/latest/), which can answer lots of frequently asked questions.
