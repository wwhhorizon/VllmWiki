# vllm-project/vllm#35285: [Bug]: Large Video Request cause vLLM Progress Core Dump

| 字段 | 值 |
| --- | --- |
| Issue | [#35285](https://github.com/vllm-project/vllm/issues/35285) |
| 状态 | open |
| 标签 | bug;stale |
...
> [Bug]: Large Video Request cause vLLM Progress Core Dump
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 2: [Bug]: Large Video Request cause vLLM Progress Core Dump bug;stale ### Your current environment ### 🐛 Describe the bug ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and a...
