# vllm-project/vllm#3601: [Bug]: Hung on building docker image

| 字段 | 值 |
| --- | --- |
| Issue | [#3601](https://github.com/vllm-project/vllm/issues/3601) |
| 状态 | closed |
| 标签 | bug |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 4: nt environment ```text $ python collect_env.py Collecting environment information... PyTorch version: 2.1.2+cu121 Is debug build: False CUDA used to build PyTorch: 12.1 ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.2...
...
- [Backend 路由与 Fallback](../patterns/backend_routing_fallback.md) - 分数 1: xruntime==1.16.3 [pip3] torch==2.1.2 [pip3] torchvision==0.15.2a0 [pip3] triton==2.1.0 [conda] blas 1.0 mkl conda-forge [conda] cudatoolkit 11.8.0 h6a678d5_0 [conda] magma 2.5.4 h610
