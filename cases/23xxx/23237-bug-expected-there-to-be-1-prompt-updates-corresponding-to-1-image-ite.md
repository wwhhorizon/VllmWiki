# vllm-project/vllm#23237: [Bug]: Expected there to be 1 prompt updates corresponding to 1 image items, but instead found 0 prompt updates! This is likely because you forgot to include input plac

| 字段 | 值 |
| --- | --- |
| Issue | [#23237](https://github.com/vllm-project/vllm/issues/23237) |
| 状态 | closed |
| 标签 | bug;stale |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: mpt updates! This is likely because you forgot to include input plac bug;stale ### Your current environment ### 🐛 Describe the bug 我使用vllm的python代码连接本地的GLM4.5VFP8模型，可以连接，可以回答问题，但是在提交照片时说我没有在提示中加入占位符，可是我有 ### Before subm...
