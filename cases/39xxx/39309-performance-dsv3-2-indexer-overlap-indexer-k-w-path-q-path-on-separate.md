# vllm-project/vllm#39309: [Performance] DSV3.2 Indexer: Overlap indexer k+w path || q path on separate CUDA streams

| 字段 | 值 |
| --- | --- |
| Issue | [#39309](https://github.com/vllm-project/vllm/issues/39309) |
| 状态 | open |
| 标签 | performance |
...
- [硬件架构 Guard](../patterns/hardware_arch_guard.md) - 分数 2: formance] DSV3.2 Indexer: Overlap indexer k+w path || q path on separate CUDA streams performance ## Motivation In the DeepSeek-V3.2 attention layer, the indexer's k+w path (`wk_weights_proj` → `k_norm`) and the q path...
...
| [#39695](https://github.com/vllm-project/vllm/pull/39695) | mentioned | 0.6 | Introduce De-dup/Similarity-Check in  CI Workflow for PR/Issue | dexer: Overlap indexer k+w path \|\| q path on separate CUDA streams \| [#39309](https://github.com/vllm-project/vllm/issues/39309) [Performance] DSV3.2 Indexer: Overlap indexer k+w… |
