# vllm-project/vllm#13026: [Usage]: max_num_seqs参数，如果多线程推理，使用异步引擎，该参数是作用于全局还是单个线程内

| 字段 | 值 |
| --- | --- |
| Issue | [#13026](https://github.com/vllm-project/vllm/issues/13026) |
| 状态 | closed |
| 标签 | usage |
...
> [Usage]: max_num_seqs参数，如果多线程推理，使用异步引擎，该参数是作用于全局还是单个线程内

### Issue 正文摘录

### Your current environment ```text 现在有个现象，多线程推理，vllm会将请求动态合并进行批处理，之后在将这批数据推理完饭回，等下次多线程调用，中间会有GPU空档期 ``` ### How would you like to use vllm I want to run inference of a [specific model](put link here). I don't know how to integrate it with vllm. ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and asked the chatbot living at the bottom right corner of the [documentation page](https://docs.vllm.ai/en/latest/), which can answer lots of frequently asked questions.
