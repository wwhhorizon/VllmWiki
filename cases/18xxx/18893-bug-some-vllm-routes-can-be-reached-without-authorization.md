# vllm-project/vllm#18893: [Bug]:some vllm routes  can be reached  without authorization

| 字段 | 值 |
| --- | --- |
| Issue | [#18893](https://github.com/vllm-project/vllm/issues/18893) |
| 状态 | closed |
| 标签 | bug |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: tilization=0.85 \ --disable-fastapi-docs \ --disable-log-requests \ --disable-uvicorn-access-log ``` I find the following routes can be reached bypass VLLM_API_KEY without authorization ``` INFO 05-29 16:17:29 [launcher...
