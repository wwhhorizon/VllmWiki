# vllm-project/vllm#16046: [Bug]: Multiple rounds of dialogue, only infering for the last round

| 字段 | 值 |
| --- | --- |
| Issue | [#16046](https://github.com/vllm-project/vllm/issues/16046) |
| 状态 | closed |
| 标签 | bug;stale |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: [Bug]: Multiple rounds of dialogue, only infering for the last round bug;stale ### Your current environment ### 🐛 Describe the bug , ### Before submitting a new issue... - [x] Make sure you already searched for relevant...
