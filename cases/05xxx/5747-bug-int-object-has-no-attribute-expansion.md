# vllm-project/vllm#5747: [Bug]: 'int' object has no attribute 'expansion'

| 字段 | 值 |
| --- | --- |
| Issue | [#5747](https://github.com/vllm-project/vllm/issues/5747) |
| 状态 | closed |
| 标签 | bug;stale |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 3: [Bug]: 'int' object has no attribute 'expansion' bug;stale ### Your current environment ```text Collecting environment information... PyTorch version: 2.3.0+cu121 Is debug build: False CUDA used to build PyTorch: 12.1 R...
