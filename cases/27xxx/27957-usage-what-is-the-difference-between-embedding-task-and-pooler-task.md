# vllm-project/vllm#27957: [Usage]: What is the difference between embedding task and pooler task?

| 字段 | 值 |
| --- | --- |
| Issue | [#27957](https://github.com/vllm-project/vllm/issues/27957) |
| 状态 | closed |
| 标签 | usage |
