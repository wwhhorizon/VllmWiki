# vllm-project/vllm#24035: [MTP][PP]: Does PP mode not support MTP? Is this how it is?

| 字段 | 值 |
| --- | --- |
| Issue | [#24035](https://github.com/vllm-project/vllm/issues/24035) |
| 状态 | closed |
| 标签 | usage;stale |
...
### Your current environment ``` Does PP mode not support MTP? Is this how it is? ``` ### How would you like to use vllm I want to run inference of a [specific model](put link here). I don't know how to integrate it with vllm. ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and asked the chatbot living at the bottom right corner of the [documentation page](https://docs.vllm.ai/en/latest/), which can answer lots of frequently asked questions.
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: [MTP][PP]: Does PP mode not support MTP? Is this how it is? usage;stale ### Your current environment ``` Does PP mode not support MTP? Is this how it is? ``` ### How would you like to use vllm I want to run inference of...
