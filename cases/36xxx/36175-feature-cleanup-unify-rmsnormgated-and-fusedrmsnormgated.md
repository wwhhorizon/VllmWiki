# vllm-project/vllm#36175: [Feature][Cleanup]: Unify RMSNormGated and FusedRMSNormGated

| 字段 | 值 |
| --- | --- |
| Issue | [#36175](https://github.com/vllm-project/vllm/issues/36175) |
| 状态 | open |
| 标签 | bug |
...
### Your current environment These are essentially duplicated. ### 🐛 Describe the bug These two nn.Modules are essentially duplicated. ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and asked the chatbot living at the bottom right corner of the [documentation page](https://docs.vllm.ai/en/latest/), which can answer lots of frequently asked questions.
