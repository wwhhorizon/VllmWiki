# vllm-project/vllm#38805: [Usage]: Does vllm support online infer for qwen3_asr_forced_aligner now? I only found offline example

| 字段 | 值 |
| --- | --- |
| Issue | [#38805](https://github.com/vllm-project/vllm/issues/38805) |
| 状态 | open |
| 标签 | usage |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 2: [Usage]: Does vllm support online infer for qwen3_asr_forced_aligner now? I only found offline example usage ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use v...
