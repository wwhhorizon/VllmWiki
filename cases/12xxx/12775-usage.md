# vllm-project/vllm#12775: [Usage]: 适配国产显卡我该如何做，工程量大么

| 字段 | 值 |
| --- | --- |
| Issue | [#12775](https://github.com/vllm-project/vllm/issues/12775) |
| 状态 | closed |
| 标签 | usage |
...
> [Usage]: 适配国产显卡我该如何做，工程量大么

### Issue 正文摘录

### Your current environment ```text 如题 ``` ### How would you like to use vllm I want to run inference of a [specific model](put link here). I don't know how to integrate it with vllm. ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and asked the chatbot living at the bottom right corner of the [documentation page](https://docs.vllm.ai/en/latest/), which can answer lots of frequently asked questions.
