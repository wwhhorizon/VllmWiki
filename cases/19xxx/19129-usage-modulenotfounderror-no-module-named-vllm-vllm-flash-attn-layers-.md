# vllm-project/vllm#19129: [Usage]: ModuleNotFoundError: No module named 'vllm.vllm_flash_attn.layers' vllm@0.9.0.1

| 字段 | 值 |
| --- | --- |
| Issue | [#19129](https://github.com/vllm-project/vllm/issues/19129) |
| 状态 | closed |
| 标签 | installation |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 5: . Defaulting to 'generate'. INFO 06-04 05:47:40 [config.py:2118] Chunked prefill is enabled with max_num_batched_tokens=16384. [/home/ubuntu/OS-NotebookLM/.conda/lib/python3.12/site-packages/vllm/transformers_utils/toke...
