# vllm-project/vllm#19646: [Usage]: Is there any vllm images include deep_ep ?

| 字段 | 值 |
| --- | --- |
| Issue | [#19646](https://github.com/vllm-project/vllm/issues/19646) |
| 状态 | closed |
| 标签 | usage;stale |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: [Usage]: Is there any vllm images include deep_ep ? usage;stale ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run inference of a [specific mo...
