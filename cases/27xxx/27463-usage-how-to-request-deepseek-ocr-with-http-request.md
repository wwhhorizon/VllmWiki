# vllm-project/vllm#27463: [Usage]: How to request DeepSeek-OCR with http request

| 字段 | 值 |
| --- | --- |
| Issue | [#27463](https://github.com/vllm-project/vllm/issues/27463) |
| 状态 | closed |
| 标签 | usage |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: [Usage]: How to request DeepSeek-OCR with http request usage ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm i want to request DeepSeek-OCR with http, is...
