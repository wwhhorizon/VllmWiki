# vllm-project/vllm#3630: [Bug]: vllm/vllm/_C.cpython-310-x86_64-linux-gnu.so: undefined symbol error

| 字段 | 值 |
| --- | --- |
| Issue | [#3630](https://github.com/vllm-project/vllm/issues/3630) |
| 状态 | closed |
| 标签 | installation |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 4: ```text The output of `python collect_env.py` Collecting environment information... PyTorch version: 2.1.2+cu121 Is debug build: False CUDA used to build PyTorch: 12.1 ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.3...
