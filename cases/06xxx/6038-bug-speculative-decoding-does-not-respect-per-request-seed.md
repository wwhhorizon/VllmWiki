# vllm-project/vllm#6038: [Bug]: Speculative decoding does not respect per-request seed

| 字段 | 值 |
| --- | --- |
| Issue | [#6038](https://github.com/vllm-project/vllm/issues/6038) |
| 状态 | closed |
| 标签 | bug |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 6: seed bug ### Your current environment ```text Collecting environment information... PyTorch version: 2.3.0+cu121 Is debug build: False CUDA used to build PyTorch: 12.1 ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.4...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 4: [Bug]: Speculative decoding does not respect per-request seed bug ### Your current environment ```text Collecting environment information... PyTorch version: 2.3.0+cu121 Is debug build: False CUDA used to build PyTorch:...
