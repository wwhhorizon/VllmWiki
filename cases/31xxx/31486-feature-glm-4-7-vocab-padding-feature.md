# vllm-project/vllm#31486: [Feature]: GLM 4.7 vocab padding feature

| 字段 | 值 |
| --- | --- |
| Issue | [#31486](https://github.com/vllm-project/vllm/issues/31486) |
| 状态 | closed |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 2: [Feature]: GLM 4.7 vocab padding feature feature request;stale ### 🚀 The feature, motivation and pitch The number of attention heads in GLM-4.7 is 96, so I’m trying to run the FP8 version with 6× H20 GPUs using tensor p...
