...
继续从本地生成的 `curated/bitwise_review_queue.csv` 中筛选 `prefix_cache_equivalence`，但 promotion 前必须阅读本地 targeted evidence JSON 或上游 issue/PR。该队列属于可再生候选材料，不提交到 GitHub。
