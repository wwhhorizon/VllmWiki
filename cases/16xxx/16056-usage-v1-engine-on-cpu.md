# vllm-project/vllm#16056: [Usage]: v1 engine on CPU

| 字段 | 值 |
| --- | --- |
| Issue | [#16056](https://github.com/vllm-project/vllm/issues/16056) |
| 状态 | closed |
| 标签 | usage |
...
### Your current environment Hi, I am reading this framework recently. I wonder why v1 engine doesn't support CPU yet? Since v1 engine has been built, I couldn't see the obstacle in it. Maybe you could help me sort it out :-) Thanks! ### How would you like to use vllm I want to run inference of a [specific model](put link here). I don't know how to integrate it with vllm. ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and asked the chatbot living at the bottom right corner of the [documentation page](https://docs.vllm.ai/en/latest/), which can answer lots of frequently asked questions.
