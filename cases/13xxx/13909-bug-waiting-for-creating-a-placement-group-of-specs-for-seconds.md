# vllm-project/vllm#13909: [Bug]: Waiting for creating a placement group of specs for seconds.

| 字段 | 值 |
| --- | --- |
| Issue | [#13909](https://github.com/vllm-project/vllm/issues/13909) |
| 状态 | closed |
| 标签 | bug;ray |
...
> [Bug]: Waiting for creating a placement group of specs for seconds.
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 7: [Bug]: Waiting for creating a placement group of specs for seconds. bug;ray ### Your current environment Collecting environment information... PyTorch version: 2.5.1+cu124 Is debug build: False CUDA used to build PyTorc...
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 5: seconds. bug;ray ### Your current environment Collecting environment information... PyTorch version: 2.5.1+cu124 Is debug build: False CUDA used to build PyTorch: 12.4 ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.5...
