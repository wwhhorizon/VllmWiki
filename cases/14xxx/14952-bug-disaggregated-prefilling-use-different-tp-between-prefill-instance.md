# vllm-project/vllm#14952: [Bug]: Disaggregated Prefilling use different TP between prefill instance and decode instance , it will be hanged

| 字段 | 值 |
| --- | --- |
| Issue | [#14952](https://github.com/vllm-project/vllm/issues/14952) |
| 状态 | closed |
| 标签 | bug;stale |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 3: [Bug]: Disaggregated Prefilling use different TP between prefill instance and decode instance , it will be hanged bug;stale ### Your current environment ### 🐛 Describe the bug ### Before submitting a new issue... - [x]...
