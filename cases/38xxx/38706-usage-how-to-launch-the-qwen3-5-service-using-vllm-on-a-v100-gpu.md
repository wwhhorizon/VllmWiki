# vllm-project/vllm#38706: [Usage]: How to launch the Qwen3.5 service using vLLM on a V100 GPU

| 字段 | 值 |
| --- | --- |
| Issue | [#38706](https://github.com/vllm-project/vllm/issues/38706) |
| 状态 | open |
| 标签 | usage |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 2: [Usage]: How to launch the Qwen3.5 service using vLLM on a V100 GPU usage ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run inference of a [s...
