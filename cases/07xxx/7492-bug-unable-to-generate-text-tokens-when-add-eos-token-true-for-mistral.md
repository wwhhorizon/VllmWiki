# vllm-project/vllm#7492: [Bug]: Unable to generate text tokens when add_eos_token = true for Mistral 7B instruct v0.1

| 字段 | 值 |
| --- | --- |
| Issue | [#7492](https://github.com/vllm-project/vllm/issues/7492) |
| 状态 | closed |
| 标签 | bug;stale |
