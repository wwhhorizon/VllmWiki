# vllm-project/vllm#12163: [New Model]: MiniCPM-o-2_6

| 字段 | 值 |
| --- | --- |
| Issue | [#12163](https://github.com/vllm-project/vllm/issues/12163) |
| 状态 | closed |
| 标签 | new-model |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 4: [New Model]: MiniCPM-o-2_6 new-model ### The model to consider. Adding support for MiniCPM-o-2, please review. HuggingFace Page: https://huggingface.co/openbmb/MiniCPM-o-2_6 MiniCPM-o 2.6 is the latest and most capable...
