# vllm-project/vllm#11822: [Usage]: Does vLLM support co-hosting multiple models on single server?

| 字段 | 值 |
| --- | --- |
| Issue | [#11822](https://github.com/vllm-project/vllm/issues/11822) |
| 状态 | closed |
| 标签 | usage |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 1: [Usage]: Does vLLM support co-hosting multiple models on single server? usage ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run inference of...
