# vllm-project/vllm#14406: [Bug]: pipeline-parallel not working properly with QwQ model on TPU v4

| 字段 | 值 |
| --- | --- |
| Issue | [#14406](https://github.com/vllm-project/vllm/issues/14406) |
| 状态 | closed |
| 标签 | bug;stale |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 5: [Bug]: pipeline-parallel not working properly with QwQ model on TPU v4 bug;stale ### Your current environment Your current environment INFO 03-04 15:53:31 [init.py:253] Automatically detected platform tpu. Collecting en...
- [Metadata 与 Layout 契约](../patterns/metadata_layout_contract.md) - 分数 2: information... PyTorch version: 2.7.0.dev20250304+cpu Is debug build: False CUDA used to build PyTorch: None ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.2 LTS (x86_64) GCC version: (Ubuntu 11.4.0-1ubuntu1~22.04) 11...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 2: ug]: pipeline-parallel not working properly with QwQ model on TPU v4 bug;stale ### Your current environment Your current environment INFO 03-04 15:53:31 [init.py:253] Automatically detected platform tpu. Collecting envi...
