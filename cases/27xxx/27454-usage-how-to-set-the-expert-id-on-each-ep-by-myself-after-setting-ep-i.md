# vllm-project/vllm#27454: [Usage]: How to set the expert id on each EP by myself after setting EP in Deepseek (how to reorder experts?)

| 字段 | 值 |
| --- | --- |
| Issue | [#27454](https://github.com/vllm-project/vllm/issues/27454) |
| 状态 | closed |
| 标签 | usage;stale |
...
- [MoE、GEMM 与 Expert Routing](../patterns/moe_gemm_routing.md) - 分数 1: [Usage]: How to set the expert id on each EP by myself after setting EP in Deepseek (how to reorder experts?) usage;stale ### Your current environment ```text vllm 0.8.5 ``` ### How would you like to use vllm I want to...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: P by myself after setting EP in Deepseek (how to reorder experts?) usage;stale ### Your current environment ```text vllm 0.8.5 ``` ### How would you like to use vllm I want to run inference of a [specific model](put lin...
