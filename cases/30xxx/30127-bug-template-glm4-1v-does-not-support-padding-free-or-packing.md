# vllm-project/vllm#30127: [Bug]: Template `glm4_1v` does not support padding free or packing

| 字段 | 值 |
| --- | --- |
| Issue | [#30127](https://github.com/vllm-project/vllm/issues/30127) |
| 状态 | closed |
| 标签 | bug |
...
> [Bug]: Template `glm4_1v` does not support padding free or packing
