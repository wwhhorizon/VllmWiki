# vllm-project/vllm#14058: [Bug]:Phi-4-Mini giving garbage outputs with torch 2.5.1 and vllm==0.7.3 with multiple parallel requests

| 字段 | 值 |
| --- | --- |
| Issue | [#14058](https://github.com/vllm-project/vllm/issues/14058) |
| 状态 | closed |
| 标签 | bug |
...
- [构建、依赖与打包](../patterns/build_dependency_packaging.md) - 分数 8: multiple parallel requests bug ### Your current environment ``` PyTorch version: 2.5.1+cu124 Is debug build: False CUDA used to build PyTorch: 12.4 ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.5 LTS (x86_64) GCC ver...
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 2: garbage outputs with torch 2.5.1 and vllm==0.7.3 with multiple parallel requests bug ### Your current environment ``` PyTorch version: 2.5.1+cu124 Is debug build: False CUDA used to build PyTorch: 12.4 ROCM used to buil...
