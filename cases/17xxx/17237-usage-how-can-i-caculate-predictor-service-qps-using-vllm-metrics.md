# vllm-project/vllm#17237: [Usage]: How can I caculate predictor service QPS，using vllm metrics

| 字段 | 值 |
| --- | --- |
| Issue | [#17237](https://github.com/vllm-project/vllm/issues/17237) |
| 状态 | closed |
| 标签 | usage;stale |
...
> [Usage]: How can I caculate predictor service QPS，using vllm metrics
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: sage]: How can I caculate predictor service QPS，using vllm metrics usage;stale ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run inference of...
