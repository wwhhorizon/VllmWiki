# vllm-project/vllm#12900: [Usage]: Failure to Init Qwen2.5-VL-7B-Instruct with inflight bnb quantization

| 字段 | 值 |
| --- | --- |
| Issue | [#12900](https://github.com/vllm-project/vllm/issues/12900) |
| 状态 | closed |
| 标签 | usage |
