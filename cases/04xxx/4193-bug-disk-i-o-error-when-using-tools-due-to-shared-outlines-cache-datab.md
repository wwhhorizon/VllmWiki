# vllm-project/vllm#4193: [Bug]: Disk I/O Error when using tools due to shared outlines cache database 

| 字段 | 值 |
| --- | --- |
| Issue | [#4193](https://github.com/vllm-project/vllm/issues/4193) |
| 状态 | closed |
| 标签 | bug |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 5: base bug ### Your current environment ```text Collecting environment information... PyTorch version: 2.1.2+cu121 Is debug build: False CUDA used to build PyTorch: 12.1 ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.3...
