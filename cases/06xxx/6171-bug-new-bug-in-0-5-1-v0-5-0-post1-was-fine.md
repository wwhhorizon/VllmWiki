# vllm-project/vllm#6171: [Bug]: New bug in 0.5.1 (v0.5.0.post1 was fine)

| 字段 | 值 |
| --- | --- |
| Issue | [#6171](https://github.com/vllm-project/vllm/issues/6171) |
| 状态 | closed |
| 标签 | bug |
...
- [构建、依赖与打包](../patterns/build_dependency_packaging.md) - 分数 7: v0.5.0.post1 was fine) bug ### Your current environment ```text PyTorch version: N/A Is debug build: N/A CUDA used to build PyTorch: N/A ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.4 LTS (x86_64) GCC version: (Ubun...
