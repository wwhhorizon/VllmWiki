# vllm-project/vllm#23567: [Bug]: openai_harmony.HarmonyError: unexpected tokens remaining in message header

| 字段 | 值 |
| --- | --- |
| Issue | [#23567](https://github.com/vllm-project/vllm/issues/23567) |
| 状态 | open |
| 标签 | bug;gpt-oss |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 1: _harmony.HarmonyError: unexpected tokens remaining in message header bug;gpt-oss ### Your current environment ### 🐛 Describe the bug ### Before submitting a new issue... - [x] Make sure you already searched for relevant...
