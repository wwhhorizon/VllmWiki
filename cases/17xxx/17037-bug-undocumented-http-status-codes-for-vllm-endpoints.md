# vllm-project/vllm#17037: [Bug]: Undocumented HTTP Status Codes for vllm endpoints

| 字段 | 值 |
| --- | --- |
| Issue | [#17037](https://github.com/vllm-project/vllm/issues/17037) |
| 状态 | closed |
