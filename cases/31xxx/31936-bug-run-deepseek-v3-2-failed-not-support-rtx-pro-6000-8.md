# vllm-project/vllm#31936: [Bug]: run deepseek v3.2 failed，not support RTX PRO 6000 * 8？

| 字段 | 值 |
| --- | --- |
| Issue | [#31936](https://github.com/vllm-project/vllm/issues/31936) |
| 状态 | open |
| 标签 | bug;unstale |
...
- [硬件架构 Guard](../patterns/hardware_arch_guard.md) - 分数 9: [Bug]: run deepseek v3.2 failed，not support RTX PRO 6000 * 8？ bug;unstale ### Your current environment Collecting environment information... ============================== System Info ============================== OS :...
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 4: * 8？ bug;unstale ### Your current environment Collecting environment information... ============================== System Info ============================== OS : Ubuntu 22.04.5 LTS (x86_64) GCC version : (Ubuntu 11.4.0...
