# vllm-project/vllm#21297: [Usage]: how to execute benchmark_serving.py with an apikey?

| 字段 | 值 |
| --- | --- |
| Issue | [#21297](https://github.com/vllm-project/vllm/issues/21297) |
| 状态 | closed |
| 标签 | usage;stale |
...
- [验证与 Benchmark](../patterns/verification_benchmarking.md) - 分数 2: [Usage]: how to execute benchmark_serving.py with an apikey? usage;stale ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run inference of a [sp...
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: [Usage]: how to execute benchmark_serving.py with an apikey? usage;stale ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run inference of a [sp...
