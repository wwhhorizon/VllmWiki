# vllm-project/vllm#29946: [Bug]: RuntimeError: Worker failed with error 'DeepGEMM backend is not available or outdated.' When deploy DeepSeek-V3.2

| 字段 | 值 |
| --- | --- |
| Issue | [#29946](https://github.com/vllm-project/vllm/issues/29946) |
| 状态 | closed |
| 标签 | bug |
