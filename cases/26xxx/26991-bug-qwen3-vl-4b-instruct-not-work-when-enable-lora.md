# vllm-project/vllm#26991: [Bug]: Qwen3-vl-4B-Instruct not work when enable lora

| 字段 | 值 |
| --- | --- |
| Issue | [#26991](https://github.com/vllm-project/vllm/issues/26991) |
| 状态 | closed |
| 标签 | bug |
...
> [Bug]: Qwen3-vl-4B-Instruct not work when enable lora
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 1: [Bug]: Qwen3-vl-4B-Instruct not work when enable lora bug ### Your current environment ### 🐛 Describe the bug ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and asked the
