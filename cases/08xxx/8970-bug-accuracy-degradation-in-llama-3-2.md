# vllm-project/vllm#8970: [Bug]: accuracy degradation in llama 3.2

| 字段 | 值 |
| --- | --- |
| Issue | [#8970](https://github.com/vllm-project/vllm/issues/8970) |
| 状态 | closed |
| 标签 | bug;stale |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 5: [Bug]: accuracy degradation in llama 3.2 bug;stale ### Your current environment Hello, I loaded `llama3.2-3b-instruct` on VLLM and observed a significant decrease in accuracy compared to when I run the model using Huggi...
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 2: [Bug]: accuracy degradation in llama 3.2 bug;stale ### Your current environment Hello, I loaded `llama3.2-3b-instruct` on VLLM and observed a significant decrease in accuracy compared to when I run the model using Huggi...
