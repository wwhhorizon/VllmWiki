# vllm-project/vllm#13264: [Bug]: Flashinfer Metadata init for speculative decoding

| 字段 | 值 |
| --- | --- |
| Issue | [#13264](https://github.com/vllm-project/vllm/issues/13264) |
| 状态 | closed |
| 标签 | bug;stale |
...
- [Backend 路由与 Fallback](../patterns/backend_routing_fallback.md) - 分数 2: [Bug]: Flashinfer Metadata init for speculative decoding bug;stale ### Your current environment ### 🐛 Describe the bug ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 2: [Bug]: Flashinfer Metadata init for speculative decoding bug;stale ### Your current environment ### 🐛 Describe the bug ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and a...
- [Bitwise 确定性与数值等价](../patterns/bitwise_determinism_equivalence.md) - 分数 1: speculative_decoding attention;cuda;operator;sampling;triton build_error;mismatch env_dependency Your current environment
