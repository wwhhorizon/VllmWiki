# vllm-project/vllm#6209: [Usage]: 目前vllm 是否支持多模态的api调用？是否支持minicpm-v2.5呢？

| 字段 | 值 |
| --- | --- |
| Issue | [#6209](https://github.com/vllm-project/vllm/issues/6209) |
| 状态 | closed |
| 标签 | usage |
...
> [Usage]: 目前vllm 是否支持多模态的api调用？是否支持minicpm-v2.5呢？
