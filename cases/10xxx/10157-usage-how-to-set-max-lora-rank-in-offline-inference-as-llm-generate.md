# vllm-project/vllm#10157: [Usage]: How to set max_lora_rank in offline inference as llm.generate?

| 字段 | 值 |
| --- | --- |
| Issue | [#10157](https://github.com/vllm-project/vllm/issues/10157) |
| 状态 | closed |
| 标签 | usage |
...
> [Usage]: How to set max_lora_rank in offline inference as llm.generate?
