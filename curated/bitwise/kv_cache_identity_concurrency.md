...
5. 对 block-table 类结构，定义并测试“逻辑长度之后必须为零”的 invariant，而不是只测试当前 append 的 slice。
...
- [#44250](https://github.com/vllm-project/vllm/issues/44250) 已有端到端复现和 patched connector 对照，但没有上游 fix PR，因此只能作为强 defer，不作为已修复结论。
