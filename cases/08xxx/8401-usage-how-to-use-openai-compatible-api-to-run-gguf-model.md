# vllm-project/vllm#8401: [Usage]: how to use openai compatible api to run GGUF model?

| 字段 | 值 |
| --- | --- |
| Issue | [#8401](https://github.com/vllm-project/vllm/issues/8401) |
| 状态 | closed |
| 标签 | usage |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 1: [Usage]: how to use openai compatible api to run GGUF model? usage ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run inference of a [specific...
