# vllm-project/vllm#6137: [Bug]: Spec. decode fails for requests with n>1 or best_of>1

| 字段 | 值 |
| --- | --- |
| Issue | [#6137](https://github.com/vllm-project/vllm/issues/6137) |
| 状态 | closed |
| 标签 | bug;stale |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 5: [Bug]: Spec. decode fails for requests with n>1 or best_of>1 bug;stale ### Your current environment ```text Collecting environment information... PyTorch version: 2.3.0+cu121 Is debug build: False CUDA used to build PyT...
