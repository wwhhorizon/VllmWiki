# vllm-project/vllm#13410: [Usage]: How to use profiler to analyze deepseek-r1 on multi nodes

| 字段 | 值 |
| --- | --- |
| Issue | [#13410](https://github.com/vllm-project/vllm/issues/13410) |
| 状态 | closed |
| 标签 | usage |
...
> [Usage]: How to use profiler to analyze deepseek-r1 on multi nodes
...
- [验证与 Benchmark](../patterns/verification_benchmarking.md) - 分数 2: [Usage]: How to use profiler to analyze deepseek-r1 on multi nodes usage ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run inference of a [sp...
