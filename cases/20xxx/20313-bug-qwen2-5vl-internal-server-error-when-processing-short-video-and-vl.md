# vllm-project/vllm#20313: [Bug]:qwen2_5vl: Internal Server Error when processing short video and vllm has been installed 0.9.0

| 字段 | 值 |
| --- | --- |
| Issue | [#20313](https://github.com/vllm-project/vllm/issues/20313) |
| 状态 | closed |
| 标签 | bug |
...
- [构建、依赖与打包](../patterns/build_dependency_packaging.md) - 分数 5: 5vl: Internal Server Error when processing short video and vllm has been installed 0.9.0 bug ### Your current environment ### 🐛 Describe the bug - https://github.com/vllm-project/vllm/issues/19477 had mentioned this bug...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 4: [Bug]:qwen2_5vl: Internal Server Error when processing short video and vllm has been installed 0.9.0 bug ### Your current environment ### 🐛 Describe the bug - https://github.com/vllm-project/vllm/issues/19477 had mentio...
