# vllm-project/vllm#27448: [Usage]: how to pass multi turn multimode messages to Vllm?

| 字段 | 值 |
| --- | --- |
| Issue | [#27448](https://github.com/vllm-project/vllm/issues/27448) |
| 状态 | closed |
| 标签 | usage;stale |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: [Usage]: how to pass multi turn multimode messages to Vllm? usage;stale ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run inference of a [spe...
