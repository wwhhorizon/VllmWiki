# vllm-project/vllm#29423: [CI Failure]: mi325_1: Python-only Installation Test

| 字段 | 值 |
| --- | --- |
| Issue | [#29423](https://github.com/vllm-project/vllm/issues/29423) |
| 状态 | closed |
| 标签 | ci-failure |
...
- [构建、依赖与打包](../patterns/build_dependency_packaging.md) - 分数 7: [CI Failure]: mi325_1: Python-only Installation Test ci-failure ### Name of failing test `bash standalone_tests/python_only_compile.sh` ### Basic information - [ ] Flaky test - [x] Can reproduce locally - [ ] Caused by
...
- [Metadata 与 Layout 契约](../patterns/metadata_layout_contract.md) - 分数 1: es this by restructuring the Dockerfile to create the expected directory layout (`mkdir src && mv vllm src/vllm`) and adds ROCm support for precompiled wheel installation. ### CC List. @kenroche
