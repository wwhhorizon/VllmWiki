# vllm-project/vllm#6861: [Bug]: Can't load BNB model

| 字段 | 值 |
| --- | --- |
| Issue | [#6861](https://github.com/vllm-project/vllm/issues/6861) |
| 状态 | closed |
| 标签 | bug;unstale |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 6: [Bug]: Can't load BNB model bug;unstale ### Your current environment ```text The output of `python collect_env.py` Collecting environment information... PyTorch version: 2.3.1+cu121 Is debug build: False CUDA used to bu...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 3: [Bug]: Can't load BNB model bug;unstale ### Your current environment ```text The output of `python collect_env.py` Collecting environment information... PyTorch version: 2.3.1+cu121 Is debug build: False CUDA used to bu...
