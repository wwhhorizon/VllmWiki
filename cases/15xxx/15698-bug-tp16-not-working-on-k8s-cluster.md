# vllm-project/vllm#15698: [Bug]: TP16 Not Working on k8s Cluster

| 字段 | 值 |
| --- | --- |
| Issue | [#15698](https://github.com/vllm-project/vllm/issues/15698) |
| 状态 | closed |
| 标签 | bug;stale |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: [Bug]: TP16 Not Working on k8s Cluster bug;stale ### Your current environment ### 🐛 Describe the bug ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and asked the chatbot l...
