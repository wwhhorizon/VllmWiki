# vllm-project/vllm#15447: [Usage]: vllm Qwen 2.5 VL output is so different from the original Qwen 2.5VL

| 字段 | 值 |
| --- | --- |
| Issue | [#15447](https://github.com/vllm-project/vllm/issues/15447) |
| 状态 | closed |
| 标签 | usage |
...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 2: [Usage]: vllm Qwen 2.5 VL output is so different from the original Qwen 2.5VL usage ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run inferen...
