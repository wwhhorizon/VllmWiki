...
4. 从 [curated/bitwise_review_queue.md](curated/bitwise_review_queue.md) 选下一批 issue 深读。
5. 回到 `cases/` 页面核对原始 issue/PR 证据。

## 当前边界

- 本地 issue 评论正文缺失，评论依赖型结论不能直接 curated。
- PR changed files 和 commit diff 不完整，需要后续补 source。
