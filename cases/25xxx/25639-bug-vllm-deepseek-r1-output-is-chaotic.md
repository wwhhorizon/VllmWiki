# vllm-project/vllm#25639: [Bug]: vllm deepseek r1 Output is chaotic

| 字段 | 值 |
| --- | --- |
| Issue | [#25639](https://github.com/vllm-project/vllm/issues/25639) |
| 状态 | closed |
| 标签 | bug;stale |
...
> [Bug]: vllm deepseek r1 Output is chaotic
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: [Bug]: vllm deepseek r1 Output is chaotic bug;stale ### Your current environment ### 🐛 Describe the bug ### Before submitting a new issue... - [x] Make sure you already searched for relevant issues, and asked the chatbo...
