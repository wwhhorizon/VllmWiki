# vllm-project/vllm#6408: [Bug]: `samplers/test_logprobs.py` fail on H100

| 字段 | 值 |
| --- | --- |
| Issue | [#6408](https://github.com/vllm-project/vllm/issues/6408) |
| 状态 | closed |
| 标签 | bug |
...
- [硬件架构 Guard](../patterns/hardware_arch_guard.md) - 分数 6: [Bug]: `samplers/test_logprobs.py` fail on H100 bug ### Your current environment ```text Collecting environment information... PyTorch version: 2.3.0+cu121 Is debug build: False CUDA used to build PyTorch: 12.1 ROCM use...
- [模型格式与 Adapter 路径](../patterns/model_format_adapter.md) - 分数 5: H100 bug ### Your current environment ```text Collecting environment information... PyTorch version: 2.3.0+cu121 Is debug build: False CUDA used to build PyTorch: 12.1 ROCM used to build PyTorch: N/A OS: Ubuntu 22.04.4...
