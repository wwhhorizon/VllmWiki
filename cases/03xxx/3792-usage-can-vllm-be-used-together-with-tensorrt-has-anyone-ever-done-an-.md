# vllm-project/vllm#3792: [Usage]: Can vllm be used together with tensorRT? Has anyone ever done an example

| 字段 | 值 |
| --- | --- |
| Issue | [#3792](https://github.com/vllm-project/vllm/issues/3792) |
| 状态 | closed |
| 标签 | usage;stale |
...
- [Scheduler 与请求状态生命周期](../patterns/scheduler_request_lifecycle.md) - 分数 1: lm be used together with tensorRT? Has anyone ever done an example usage;stale ### Your current environment ```text The output of `python collect_env.py` ``` ### How would you like to use vllm I want to run inference of...
