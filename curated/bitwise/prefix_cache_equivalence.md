...
- [#42699](https://github.com/vllm-project/vllm/issues/42699) 与 [#40896](https://github.com/vllm-project/vllm/issues/40896) 是 open issue：评论提供复现和 mitigation 线索，但没有 linked fix、changed files 或 maintainer resolution，仍只算风险与分流线索，不进入代表证据。
